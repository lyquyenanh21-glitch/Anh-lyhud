...
local Tabs = {
    ...
    Main4=Window:AddTab({Title="script vặt ah em tự lọ"})
}

-- Tab 0: Thông Tin
Tabs.Main0:AddButton({
    Title="tiktok",
    Description="anh.vip.pro.fruits",
    Callback=function()
        setclipboard("**********")
    end
})
...
Tabs.Main1:AddButton({
    Title="Fix Lag",
    Callback=function()
        loadstring(game:HttpGet("https://pastefy.app/rGOebqwl/raw"))()
    end
})
Tabs.Main1:AddButton({
    Title="Min Hub",
...
-- Tab 4: script vặt ah em tự lọ
Tabs.Main4:AddButton({
    Title="fly kill của anh",
    Callback=function()
       loadstring(game:HttpGet("https://pastefy.app/OLN6qIDj/raw"))()
    end
})
Tabs.Main4:AddButton({
    Title="speed của anh",
    Callback=function()
       loadstring(game:HttpGet("https://pastefy.app/xWnuUw4M/raw"))()
    end
})
Tabs.Main4:AddButton({
    Title="camlock của anh",
    Callback=function()
       loadstring(game:HttpGet("https://pastefy.app/QbdMftGE/raw"))()
    end
})
Tabs.Main4:AddButton({
    Title="fly của anh",
    Callback=function()
       loadstring(game:HttpGet("https://pastefy.app/TBdAs7N7/raw"))()
    end
})
Tabs.Main4:AddButton({
    Title="m1 blox fruit của anh",
    Callback=function()
       loadstring(game:HttpGet("https://raw.githubusercontent.com/lyquyenanh21-glitch/Anh-lyhud/refs/heads/main/hackphu2.lua"))()
    end
})
Tabs.Main4:AddButton({
    Title="noclip của anh",
    Callback=function()
       loadstring(game:HttpGet("https://pastefy.app/KJIms7I6/raw"))()
    end
})
Tabs.Main4:AddButton({
    Title="god mod của anh",
    Callback=function()
       loadstring(game:HttpGet("https://pastefy.app/0DVVVgRk/raw"))()
    end
})
